output "vm_private_ssh_key_secret_values" {
  ...
  value = {
    for k, v in module.local_virtual_machine_linux : v.virtual_machine_name => v.private_ssh_key_secret_value
  }
  sensitive = true
}
...
output "vm_public_ssh_key_secret_values" {
  ...
  value = {
    for k, v in module.local_virtual_machine_linux : v.virtual_machine_name => v.public_ssh_key_secret_value
  }
  sensitive = true
}
...
output "vm_admin_passwords" {
  ...
  value = {
    for k, v in module.local_virtual_machine_linux : v.virtual_machine_name => v.vm_admin_password
  }
  sensitive = true
}
...
output "virtual_machine_ids" {
  ...
  value = {
    for k, v in module.local_virtual_machine_linux : v.virtual_machine_name => v.virtual_machine_id
  }
}
...
output "virtual_machine_names" {
  ...
  value = {
    for k, v in module.local_virtual_machine_linux : k => v.virtual_machine_name
  }
}
...
output "virtual_machine_ips" {
  ...
  value = {
    for k, v in module.local_virtual_machine_linux : v.virtual_machine_name => {
...
output "virtual_machine_remote_by_public_ips" {
  ...
  value = {
    for k, v in module.local_virtual_machine_linux : v.virtual_machine_name => v.remote_by_public_ip
  }
}
...
output "virtual_machine_nic_id" {
  description = "A map of the Azure Resource IDs for all Linux Virtual Machines."
  value = {
    for k, v in module.local_virtual_machine_linux : v.virtual_machine_name => v.nic_id
  }
}
